#!/usr/bin/env python3
"""
Создание модели среднего размера для ESP32
"""
...
def create_medium_model():
    """Создает модель среднего размера"""
    
    # Средняя архитектура - баланс между размером и качеством
    ...
    # Обучаем на фиктивных данных (3 эпохи)
    model.fit(dummy_data, dummy_labels, epochs=3, verbose=0)
    ...
    print(f"✅ Средняя модель создана: {tflite_path}")
